...
class MessageCenterViewSet(CustomModelViewSet):
    ...
    def get_self_receive(self, request):
        ...
        if page is not None:
            serializer = MessageCenterTargetUserListSerializer(page, many=True)
            return self.get_paginated_response(serializer.data)
        serializer = MessageCenterTargetUserListSerializer(queryset, many=True)
    ...
    def get_newest_msg(self, request):
        ...
        data = None
        if queryset:
            serializer = MessageCenterTargetUserListSerializer(queryset.messagecenter, many=False)
